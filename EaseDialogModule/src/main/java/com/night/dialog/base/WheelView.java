...
import static com.night.dialog.base.WheelScrollerKt.MIN_DELTA_FOR_SCROLLING;
...
import com.night.dialog.callback.IWheelClickedListener;
import com.night.dialog.callback.IWheelScrollListener;
...
public class WheelView extends View {
    ...
    // View adapter
    private IWheelViewAdapter viewAdapter;

    // Recycle
    private WheelRecycle recycle = new WheelRecycle(this);

    // Listeners
    private List<IWheelChangedListener> changingListeners = new LinkedList<IWheelChangedListener>();

    private List<IWheelScrollListener> scrollingListeners = new LinkedList<IWheelScrollListener>();

    private List<IWheelClickedListener> clickingListeners = new LinkedList<IWheelClickedListener>();
    ...
    WheelScroller.ScrollingListener scrollingListener = new WheelScroller.ScrollingListener() {
        ...
        public void onJustify() {
            if (Math.abs(scrollingOffset) > MIN_DELTA_FOR_SCROLLING) {
...
//    }
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (IWheelChangedListener listener : changingListeners) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (IWheelScrollListener listener : scrollingListeners) {
    ...
    protected void notifyClickListenersAboutClick(int item) {
        for (IWheelClickedListener listener : clickingListeners) {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(DialogHelp.INSTANCE.getColor(R.color.colorDivider));
        // 设置线宽
