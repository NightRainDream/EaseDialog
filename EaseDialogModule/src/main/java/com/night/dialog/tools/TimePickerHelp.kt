...
//     */
//    fun initHourLabel(activity: Activity, idHour: WheelViewS?) {
//        if (idHour == null) {
//            return
//        }
//        hourList.clear()
...
//     */
//    fun initMinuteLabel(activity: Activity, idMinute: WheelViewS?) {
//        if (idMinute == null) {
//            return
//        }
//        minuteList.clear()
...
//     */
//    fun initSecondLabel(activity: Activity, idSecond: WheelViewS?) {
//        if (idSecond == null) {
//            return
//        }
//        secondList.clear()
